...
const ViewReceipt = () => {
    ...
    // table code ...
    function createData(name, billdate, originalamount, refund, refundreason, refundby, totalamount, action) {
        return { name, billdate, originalamount, refund, refundreason, refundby, totalamount, action };
    }

    const rows = [
        createData('Sumit Girish Solapurkar', 9822179160, 'Male', 24, 4.0, "Nagpur", 9876543221010, '21-09-2024'),
        createData('Sumit Girish Solapurkar', 9822179160, 'Male', 24, 4.0, "Nagpur", 9876543221010, '21-09-2024'),
        createData('Sumit Girish Solapurkar', 9822179160, 'Male', 24, 4.0, "Nagpur", 9876543221010, '21-09-2024'),
                ...
                <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="left">Refund Reason</TableCell>
                            <TableCell align="left">Refund By</TableCell>
                    ...
                    <TableBody>
                        {rows.map((row, index) => (
                            ...
                            >
                                ...
                                <TableCell align="left">{row.refundby}</TableCell>
